...
def main() -> None:
    ...
    ap.add_argument("--episode-dir", type=pathlib.Path, default=ROOT / "Episode",
                    help="directory containing episode source videos")
    ...
    required.extend(episode_dir / mapping[name] for name in names)
        ...
        for attempt in range(1, args.max_attempts + 1):
            ...
            try:
                report = process_episode(
                    name, episode_dir / mapping[name], candidate, map_out,
