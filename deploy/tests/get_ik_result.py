def main():
    ...
    sys.path.insert(0, '/home/kimminje/Desktop/project/gopro_umi/deploy')
    from ik.ik_solver_v7 import DLSInverseKinematicsV7
    ik_solver = DLSInverseKinematicsV7(urdf_path="/home/kimminje/Desktop/project/gopro_umi/urdf/so_arm_with_gopro_final.urdf")
