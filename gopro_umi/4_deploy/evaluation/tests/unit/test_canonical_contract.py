...
def test_gripper_endpoint_contract_clamp_monotonicity_and_roundtrip():
    ...
    assert mapping.gripper_raw_from_width(1.0) == 600
    assert mapping.gripper_raw_from_width(0.0) == 3000
    assert mapping.gripper_raw_from_width(0.5) == 1800
    assert mapping.gripper_raw_from_width(0.25) == 2400
    assert mapping.gripper_raw_from_width(0.75) == 1200
