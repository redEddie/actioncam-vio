...
MODEL_PATH = PROJECT_ROOT / "Delta_Weights"
ZARR_PATH = PROJECT_ROOT / "archive/legacy_dataset/zarr/replay_buffer_yawfree.zarr"
...
def main():
    ...
    parser.add_argument("--report-md", type=Path, default=PROJECT_ROOT / "reports/STEP10B_LOCAL_FULL_MODEL_EPISODE_DIRECTION_EVAL.md")
    parser.add_argument("--report-csv", type=Path, default=PROJECT_ROOT / "reports/evaluation_results.csv")
    parser.add_argument("--report-json", type=Path, default=PROJECT_ROOT / "reports/evaluation_summary.json")
