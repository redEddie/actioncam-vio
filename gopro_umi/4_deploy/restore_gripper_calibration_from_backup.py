...
project calibration JSON and gripper motor registers, with the requested
conservative raw range forced to 600..3000. Default mode prints the planned
values; ``--execute`` is required for the JSON and motor writes.
"""
...
ACTIVE = deploy.PROJECT_ROOT / "smolvla_cache/lerobot/calibration/robots/so_follower/None.json"
BACKUP = deploy.PROJECT_ROOT / "smolvla_cache/lerobot/calibration/robots/so_follower/None.before_encoder_recalibration_20260805.json"
GRIPPER_RANGE_MIN_RAW = 600
GRIPPER_RANGE_MAX_RAW = 3000
...
def main() -> int:
    ...
    restore["range_min"] = GRIPPER_RANGE_MIN_RAW
    restore["range_max"] = GRIPPER_RANGE_MAX_RAW
