...
def main():
    print("=" * 50)
    print("🦀 그리퍼 최대 닫힘 한계(RAW 값) 찾기")
    print("천천히 닫힙니다. 완전히 닫혔을 때 [Ctrl+C]를 눌러 멈추세요!")
    print("=" * 50)
    ...
    step_size = 10.0 # 0.1초마다 10씩 증가 (값이 커질수록 닫힘)
    
    try:
        while current_raw <= 5000:
            action = {}
            # 팔 관절 유지
