...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--source", type=Path, default=root / "7_storage/zarr/replay_buffer.zarr")
    parser.add_argument(
        "--output", "-o", type=Path, default=root / "7_storage/zarr/replay_buffer_yawfree.zarr"
    )
...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        attrs = {
            ...
            "yaw_removed": True,
            "source_zarr": "7_storage/zarr/replay_buffer.zarr",
