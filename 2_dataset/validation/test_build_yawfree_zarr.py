...
SCRIPT = PROJECT_ROOT / "2_dataset/conversion/build_yawfree_zarr.py"
...
class YawFreeBuilderTest(unittest.TestCase):
    ...
    def test_project_relative_defaults_and_existing_scope_audit(self) -> None:
        ...
        self.assertEqual(
            args.source.resolve(),
            PROJECT_ROOT / "7_storage/zarr/replay_buffer.zarr",
        )
        self.assertEqual(
            args.output.resolve(),
            PROJECT_ROOT / "7_storage/zarr/replay_buffer_yawfree.zarr",
        )
        ...
        migrated_output = PROJECT_ROOT / "7_storage/datasets/202608161336/02_zarr/replay_buffer_yawfree.zarr"
