...
# Add etc/third_party/lerobot and 4_deploy to python path
...
WEIGHTS_DIR = PROJECT_ROOT / "7_storage" / "Delta_Weights"
TRAINING_DIR = PROJECT_ROOT / "3_training"
CONVERSION_DIR = PROJECT_ROOT / "2_dataset" / "conversion"
CANONICAL_DATASET_NAME = "lerobot_dataset_10hz_chunk15_incremental_baseline_v1"
DATASET_DIR = PROJECT_ROOT / "7_storage" / "lerobot" / CANONICAL_DATASET_NAME
...
def audit_static_configs() -> dict[str, Any]:
    ...
    # 1. 7_storage/Delta_Weights/config.json
    ...
    # 2. 7_storage/Delta_Weights/policy_postprocessor.json
    ...
    # 3. 7_storage/Delta_Weights/policy_preprocessor.json
